        ...
        <div class="col-span-12 lg:col-span-8 xl:col-span-9">
            <div :class="$store.breakpoints.smAndUp && 'via-purple-300'" class="card mt-12 bg-gradient-to-l from-pink-300 to-indigo-400 p-5 sm:mt-0 sm:flex-row">
                ...
                <div class="mt-2 flex-1 pt-2 text-center text-white sm:mt-0 sm:text-left">
                    <h3 class="text-xl">Welcome Backaad, <span class="font-semibold">Caleb</span></h3>
                ...
                <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5">
                    <div class="card flex-row overflow-hidden">
                        ...
                        <div class="flex flex-1 flex-col justify-between p-4 sm:px-5">
                            <div>
                                <img class="h-12 w-12 rounded-lg object-cover object-center" src="<?=base_url();?>assets/images/others/testing-sm.jpg" alt="image" />
                            ...
                            <div class="mt-10 flex justify-between">
                                <div class="flex -space-x-2">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="<?=base_url();?>assets/images/avatar/avatar-16.jpg" alt="avatar" />
                                    </div>
                                    ...
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="<?=base_url();?>assets/images/avatar/avatar-19.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                    ...
                    <div class="card flex-row overflow-hidden">
                        ...
                        <div class="flex flex-1 flex-col justify-between p-4 sm:px-5">
                            <div>
                                <img class="h-12 w-12 rounded-lg object-cover object-center" src="<?=base_url();?>assets/images/others/design-sm.jpg" alt="image" />
                                <h3 class="mt-3 font-medium text-slate-700 line-clamp-2 dark:text-navy-100">
                                    Learn UI/UX Design
                                </h3>
                                <p class="text-xs+">Tue. 10:00 - 11:30</p>
                                <div class="mt-2 flex space-x-1.5">
                                    <a href="<?=base_url();?>assets/#" class="tag bg-info py-1 px-1.5 text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90">
                                        UI/UX Design
                                    </a>
                                </div>
                            </div>
                            <div class="mt-10 flex justify-between">
                                <div class="flex -space-x-2">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="<?=base_url();?>assets/images/avatar/avatar-20.jpg" alt="avatar" />
                                    </div>
                                    ...
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="<?=base_url();?>assets/images/avatar/avatar-17.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 hover:shadow-lg hover:shadow-slate-200/50 focus:bg-slate-200 focus:shadow-lg focus:shadow-slate-200/50 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:hover:shadow-navy-450/50 dark:focus:bg-navy-450 dark:focus:shadow-navy-450/50 dark:active:bg-navy-450/90"
                    ...
                    <div class="card flex-row overflow-hidden">
                        ...
                        <div class="flex flex-1 flex-col justify-between p-4 sm:px-5">
                            <div>
                                <img class="h-12 w-12 rounded-lg object-cover object-center" src="<?=base_url();?>assets/images/others/sales-presentation-sm.jpg" alt="image" />
                                <h3 class="mt-3 font-medium text-slate-700 line-clamp-2 dark:text-navy-100">
                                    Basic of digital marketing
                                </h3>
                                <p class="text-xs+">Wed. 09:00 - 11:00</p>
                                <div class="mt-2 flex space-x-1.5">
                                    <a href="<?=base_url();?>assets/#" class="tag bg-secondary px-1.5 py-1 text-white hover:bg-secondary-focus focus:bg-secondary-focus active:bg-secondary-focus/90">
                                        Marketing
                                    </a>
                                </div>
                            </div>
                        ...
                        <table class="is-hoverable w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <a href="<?=base_url();?>assets/#" class="hover:underline focus:underline">English book.pdf </a>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <span class="font-medium text-slate-700 dark:text-navy-100">Grammar and Punctuation </span>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <a href="<?=base_url();?>assets/#" class="hover:underline focus:underline">Is Correct.docx </a>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <span class="font-medium text-slate-700 dark:text-navy-100">Practice speaking English </span>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <a href="<?=base_url();?>assets/#" class="hover:underline focus:underline">Speaking.mp3 </a>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="badge space-x-2.5 text-slate-800 dark:text-navy-100">
                                            <div class="h-2 w-2 rounded-full bg-current"></div>
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <a href="<?=base_url();?>assets/#" class="hover:underline focus:underline">
                                            English books.zip
                                        </a>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                ...
                                <tr class="border-y border-transparent">
                                    <td class="whitespace-nowrap rounded-bl-lg px-4 py-3 sm:px-5">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <span class="font-medium text-slate-700 dark:text-navy-100">Basic of digital marketing </span>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <a href="<?=base_url();?>assets/#" class="hover:underline focus:underline">Digital marketing.pdf </a>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="badge space-x-2.5 text-slate-800 dark:text-navy-100">
                                            <div class="h-2 w-2 rounded-full bg-current"></div>
                    ...
                    <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-x-5 lg:grid-cols-1">
                            ...
                            <div class="flex items-center justify-between space-x-2">
                                <div class="flex items-center space-x-3">
                                    <div class="avatar h-10 w-10">
                                        <img class="rounded-full" src="<?=base_url();?>assets/images/avatar/avatar-20.jpg" alt="avatar" />
                        ...
                        <div class="card p-3">
                            <div class="flex items-center justify-between space-x-2">
                                <div class="flex items-center space-x-3">
                                    <div class="avatar h-10 w-10">
                                        <img class="rounded-full" src="<?=base_url();?>assets/images/avatar/avatar-19.jpg" alt="avatar" />
                                    </div>
                                    <div>
                                        <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                                            Konnor Guzman
                        ...
                        <div class="card p-3">
                            <div class="flex items-center justify-between space-x-2">
                                <div class="flex items-center space-x-3">
                                    <div class="avatar h-10 w-10">
                                        <img class="rounded-full" src="<?=base_url();?>assets/images/avatar/avatar-18.jpg" alt="avatar" />
                                    </div>
                                    <div>
                                        <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                                            Alfredo Elliott
                        ...
                        <div class="card p-3">
                            <div class="flex items-center justify-between space-x-2">
                                <div class="flex items-center space-x-3">
                                    <div class="avatar h-10 w-10">
                                        <img class="rounded-full" src="<?=base_url();?>assets/images/avatar/avatar-5.jpg" alt="avatar" />
                                        <div class="absolute right-0 h-3 w-3 rounded-full border-2 border-white bg-primary dark:border-navy-700 dark:bg-accent"></div>
                                    </div>
                                    <div>
                                        <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
